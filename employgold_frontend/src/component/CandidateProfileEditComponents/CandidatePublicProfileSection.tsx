...
interface ICandidatePublicProfileSection {
...
export default function CandidatePublicProfileSection(
  props: ICandidatePublicProfileSection
) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Avatar sx={{ width: '320px', height: '320px' }}>PlaceHolder</Avatar>
          <TextField
          ...
          <TextField
            ...
            InputLabelProps={{ shrink: Boolean(publicProfile.headlineSummary) }}
